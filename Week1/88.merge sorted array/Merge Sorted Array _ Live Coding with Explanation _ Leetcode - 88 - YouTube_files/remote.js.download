(function(g){var window=this;'use strict';var b_a=function(a,b,c){null!=c&&(g.Bd(a,b,1),a=a.j,b=c>>>0,c=Math.floor((c-b)/4294967296)>>>0,g.Xe=b,g.We=c,g.zd(a,g.Xe),g.zd(a,g.We))},c_a=function(a,b,c){b=g.Rd(b,c);
null!=b&&(g.Bd(a,c,0),a.j.j.push(b?1:0))},d_a=function(a,b){return g.Wf(a,b)},e_a=function(a,b){b=b instanceof g.Xg?b:g.ch(b,/^data:image\//i.test(b));
a.src=g.Yg(b)},g_a=function(a){g.F.call(this,a,-1,f_a)},h_a=function(a){g.F.call(this,a)},k_a=function(){return[1,
i_a,2,j_a]},l_a=function(){return[1,
g.wq,h_a,k_a]},m_a=function(a){g.F.call(this,a)},n_a=function(a){g.F.call(this,a)},p_a=function(){return[1,
g.yq,2,g.yq,3,o_a]},q_a=function(a){g.F.call(this,a)},s_a=function(){return[1,
g.yq,2,g.yq,3,r_a,4,o_a]},u_a=function(){return[1,
g.lf,n_a,p_a,t_a,2,g.lf,q_a,s_a,t_a]},y_a=function(){return[1,
v_a,g.$i,2,w_a,g.$i,3,x_a,g.$i]},B_a=function(){return[1,
z_a,g.Zi,2,A_a,g.Zi,3,g.lf,g_a,l_a,g.Zi]},D_a=function(){return[1,
g.wq,g.Xi,y_a,2,C_a,g.Yi,B_a]},H_a=function(){return[1,
g.yq,5,E_a,2,C_a,m_a,u_a,3,F_a,6,G_a,4,g.wq,g.Wi,D_a]},l6=function(a){g.Rk(a,"zx",Math.floor(2147483648*Math.random()).toString(36)+Math.abs(Math.floor(2147483648*Math.random())^g.Xa()).toString(36));
return a},m6=function(a,b,c){Array.isArray(c)||(c=[String(c)]);
g.Hda(a.B,b,c)},I_a=function(a){if(a===g.Kn)throw Error("ES6 Iteration protocol does NOT adjust control flow when StopIteration is thrown from callback helper functions. If your code relies on this behavior, consider throwing a different error and catching it to terminate iteration.");
throw a;},J_a=function(a){if(a instanceof g.In)return a;
...
return c}throw Error("Not implemented");},K_a=function(a,b,c){if(g.Pa(a))try{g.yc(a,b,c)}catch(e){I_a(e)}else for(a=J_a(a);;){var d=void 0;
try{d=a.Qm()}catch(e){if(e===g.Kn)break;throw e;}try{b.call(c,d,void 0,a)}catch(e){I_a(e)}}},L_a=function(a,b){var c=[];
K_a(b,function(d){try{var e=g.eq.prototype.u.call(this,d,!0)}catch(f){if("Storage: Invalid value was encountered"==f)return;throw f;}void 0===e?c.push(d):g.Dia(e)&&c.push(d)},a);
return c},M_a=function(a,b){L_a(a,b).forEach(function(c){g.eq.prototype.remove.call(this,c)},a)},N_a=function(a){if(a.oa){if(a.oa.locationOverrideToken)return{locationOverrideToken:a.oa.locationOverrideToken};
if(null!=a.oa.latitudeE7&&null!=a.oa.longitudeE7)return{latitudeE7:a.oa.latitudeE7,longitudeE7:a.oa.longitudeE7}}return null},O_a=function(a,b){g.ec(a,b)||a.push(b)},n6=function(a){var b=0,c;
for(c in a)b++;return b},P_a=function(a){try{return g.C.JSON.parse(a)}catch(b){}a=String(a);
if(/^\s*$/.test(a)?0:/^[\],:{}\s\u2028\u2029]*$/.test(a.replace(/\\["\\\/bfnrtu]/g,"@").replace(/(?:"[^"\\\n\r\u2028\u2029\x00-\x08\x0a-\x1f]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?)[\s\u2028\u2029]*(?=:|,|]|}|$)/g,"]").replace(/(?:^|:|,)(?:[\s\u2028\u2029]*\[)+/g,"")))try{return eval("("+a+")")}catch(b){}throw Error("Invalid JSON string: "+a);},o6=function(a){if(g.C.JSON)try{return g.C.JSON.parse(a)}catch(b){}return P_a(a)},Q_a=function(a,b,c,d){var e=new g.Ek(null,void 0);
...
g.Pn(b.split(","),g.Wa(d_a,T_a)).forEach(function(c){a.capabilities.add(c)})},S_a=function(a,b){a.experiments.clear();
...
screenId:a.id,loungeToken:a.token,dialId:a.uuid,screenIdType:a.idType}},V_a=function(a){return new r6(a)},W_a=function(a){return Array.isArray(a)?g.Vl(a,V_a):[]},t6=function(a){return a?'{name:"'+a.name+'",id:'+a.id.substr(0,6)+"..,token:"+((a.token?".."+a.token.slice(-6):"-")+",uuid:"+(a.uuid?".."+a.uuid.slice(-6):"-")+",idType:"+a.idType+"}"):"null"},u6=function(a){return Array.isArray(a)?"["+g.Vl(a,t6).join(",")+"]":"null"},v6=function(){return"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,
function(a){var b=16*Math.random()|0;
return("x"==a?b:b&3|8).toString(16)})},X_a=function(a){return g.Vl(a,function(b){return{key:b.id,
name:b.name}})},w6=function(a,b){return g.$b(a,function(c){return c||b?!c!=!b?!1:c.id==b.id:!0})},x6=function(a,b){return g.$b(a,function(c){return s6(c,b)})},Y_a=function(){var a=(0,g.Jw)();
a&&M_a(a,a.j.Jh(!0))},y6=function(){var a=g.Mw("yt-remote-connected-devices")||[];
g.uc(a);return a},Z_a=function(a){if(g.gc(a))return[];
var b=a[0].indexOf("#"),c=-1==b?a[0]:a[0].substring(0,b);return g.Vl(a,function(d,e){return 0==e?d:d.substring(c.length)})},$_a=function(a){g.Lw("yt-remote-connected-devices",a,86400)},A6=function(){if(z6)return z6;
...
g.ec(a,b);g.Ow()&&g.xc(a,b);a=Z_a(a);if(g.gc(a))try{g.lma("remote_sid")}catch(c){}else try{g.ts("remote_sid",a.join(","),-1)}catch(c){}},a0a=function(){return g.Mw("yt-remote-session-browser-channel")},b0a=function(){return g.Mw("yt-remote-local-screens")||[]},c0a=function(){g.Lw("yt-remote-lounge-token-expiration",!0,86400)},d0a=function(a){5<a.length&&(a=a.slice(a.length-5));
var b=g.Vl(b0a(),function(d){return d.loungeToken}),c=g.Vl(a,function(d){return d.loungeToken});
g.em(c,function(d){return!g.ec(b,d)})&&c0a();
g.Lw("yt-remote-local-screens",a,31536E3)},C6=function(a){a||(g.Nw("yt-remote-session-screen-id"),g.Nw("yt-remote-session-video-id"));
B6();a=y6();g.jc(a,A6());$_a(a)},e0a=function(){if(!D6){var a=g.nq();
a&&(D6=new g.bq(a))}},f0a=function(){e0a();
return D6?!!D6.get("yt-remote-use-staging-server"):!1},E6=function(){var a=window.navigator.userAgent.match(/Chrome\/([0-9]+)/);
return a?parseInt(a[1],10):0},g0a=function(a){return!!document.currentScript&&(-1!=document.currentScript.src.indexOf("?"+a)||-1!=document.currentScript.src.indexOf("&"+a))},h0a=function(){return"function"==typeof window.__onGCastApiAvailable?window.__onGCastApiAvailable:null},F6=function(a){a.length?i0a(a.shift(),function(){F6(a)}):G6()},j0a=function(a){return"chrome-extension://"+a+"/cast_sender.js"},i0a=function(a,b,c){var d=document.createElement("script");
d.onerror=b;c&&(d.onload=c);g.fk(d,g.Sp(a));(document.head||document.documentElement).appendChild(d)},k0a=function(){var a=E6(),b=[];
if(1<a){var c=a-1;b.push("//www.gstatic.com/eureka/clank/"+a+"/cast_sender.js");b.push("//www.gstatic.com/eureka/clank/"+c+"/cast_sender.js")}return b},G6=function(){var a=h0a();
a&&a(!1,"No cast extension found")},H6=function(){if(l0a){var a=2,b=h0a(),c=function(){a--;
0==a&&b&&b(!0)};
window.__onGCastApiAvailable=c;i0a("//www.gstatic.com/cast/sdk/libs/sender/1.0/cast_framework.js",G6,c)}},m0a=function(){H6();
var a=k0a();a.push("//www.gstatic.com/eureka/clank/cast_sender.js");F6(a)},o0a=function(){H6();
var a=k0a();a.push.apply(a,g.v(n0a.map(j0a)));a.push("//www.gstatic.com/eureka/clank/cast_sender.js");F6(a)},p0a=function(){this.j=I6();
this.j.sz("/client_streamz/youtube/living_room/mdx/browser_channel/closed_channels")},q0a=function(){this.j=I6();
this.j.sz("/client_streamz/youtube/living_room/mdx/browser_channel/pending_maps")},r0a=function(){this.j=I6();
...
var b=a.B;a.B=null;a.C.apply(null,b)},M6=function(){},N6=function(){g.xf.call(this,"p")},O6=function(){g.xf.call(this,"o")},s0a=function(){var a=new g.C.TextEncoder;
...
document.head.appendChild(c),(new Request("",{body:new ReadableStream,method:"POST"})).headers.has("Content-Type")||(g.C.fetch(a+"?ot=1",{method:"POST",body:"test\r\n"}).catch(b),g.C.fetch(a+"?ot=2",{method:"POST",body:s0a(),vT:!1}).catch(b),g.C.fetch(a+"?ot=3",{method:"POST",body:s0a(),vT:!0}).catch(b)))}},P6=function(){return w0a=w0a||new g.xg},x0a=function(a){g.xf.call(this,"serverreachability",a)},Q6=function(a){var b=P6();
b.dispatchEvent(new x0a(b,a))},y0a=function(a,b){g.xf.call(this,"statevent",a);
this.stat=b},R6=function(a){var b=P6();
b.dispatchEvent(new y0a(b,a))},z0a=function(a,b,c,d){g.xf.call(this,"timingevent",a);
...
W6(a);a.Va=a.K.clone();m6(a.Va,"t",a.Eb);a.Z=0;var c=a.D.Ja;a.u=new A0a;a.j=C0a(a.D,c?b:null,!a.N);0<a.jb&&(a.Sa=new K6((0,g.Ta)(a.TJ,a,a.j),a.jb));a.Ya.Pa(a.j,"readystatechange",a.DS);b=a.Ia?g.dg(a.Ia):{};a.N?(a.xa||(a.xa="POST"),b["Content-Type"]="application/x-www-form-urlencoded",a.j.send(a.Va,a.xa,a.N,b)):(a.xa="GET",a.j.send(a.Va,a.xa,null,b));Q6(1)},X6=function(a){return a.j?a.u.u?!0:!(!g.Nj(a.j)&&!g.Oj(a.j)):!1},D0a=function(a){return a.j?"GET"==a.xa&&2!=a.Ja&&a.D.fd:!1},F0a=function(a,b,
c){for(var d=!0,e;!a.Ea&&a.Z<c.length;)if(e=E0a(a,c),e==Y6){4==b&&(a.J=4,R6(14),d=!1);
break}else if(e==Z6){a.J=4;R6(15);d=!1;break}else $6(a,e);D0a(a)&&e!=Y6&&e!=Z6&&(a.u.j="",a.Z=0);4!=b||0!=c.length||a.u.u||(a.J=1,R6(16),d=!1);a.B=a.B&&d;d?0<c.length&&!a.Db&&(a.Db=!0,a.D.NG(a)):(a7(a),b7(a))},E0a=function(a,b){var c=a.Z,d=b.indexOf("\n",c);
...
a.X=S6((0,g.Ta)(a.BS,a),b)},c7=function(a){a.X&&(g.C.clearTimeout(a.X),a.X=null)},b7=function(a){a.D.cf()||a.Ea||H0a(a.D,a)},a7=function(a){c7(a);
...
if(null!=a.j&&0!==a.j.size){var b=a.B;a=g.q(a.j.values());for(var c=a.next();!c.done;c=a.next())b=b.concat(c.value.ma);return b}return g.mc(a.B)},O0a=function(a,b){var c=new T6;
...
}},n7=function(a,b,c){return c&&c.iV?c.iV[a]||b:b},R0a=function(a){this.B=[];
...
new M0a(a&&a.xga);this.Wf=new P0a;this.kb=a&&a.Hga||!1;this.jb=a&&a.Fga||!1;this.kb&&this.jb&&(this.jb=!1);this.le=a&&a.rga||!1;a&&a.Jga&&(this.Lb=!1);this.Sb=!this.kb&&this.Lb&&a&&a.Cga||!1;this.Tb=void 0;this.Ub=0;this.Ya=!1;this.xa=null;this.Ug=!a||!1!==a.Ega;this.rb=null},f7=function(a){a.j&&(o7(a),a.j.cancel(),a.j=null)},S0a=function(a){f7(a);
a.N&&(g.C.clearTimeout(a.N),a.N=null);e7(a);a.u.cancel();a.J&&("number"===typeof a.J&&g.C.clearTimeout(a.J),a.J=null)},k7=function(a){N0a(a.u)||a.J||(a.J=!0,g.Ii(a.WJ,a),a.oa=0)},U0a=function(a,b){if(h7(a.u)>=a.u.C-(a.J?1:0))return!1;
if(a.J)return a.B=b.ma.concat(a.B),!0;if(1==a.qf||2==a.qf||a.oa>=(a.Gd?0:a.Pd))return!1;a.J=S6((0,g.Ta)(a.WJ,a,b),T0a(a,a.oa));a.oa++;return!0},W0a=function(a,b){var c;
b?c=b.Gb:c=a.Sa++;var d=a.Ia.clone();g.Rk(d,"SID",a.C);g.Rk(d,"RID",c);g.Rk(d,"AID",a.Oa);p7(a,d);a.K&&a.X&&g.Yk(d,a.K,a.X);c=new U6(a,a.C,c,a.oa+1);null===a.K&&(c.Ia=a.X);b&&(a.B=b.ma.concat(a.B));b=V0a(a,c,1E3);c.setTimeout(Math.round(.5*a.lc)+Math.round(.5*a.lc*Math.random()));j7(a.u,c);V6(c,d,b)},p7=function(a,b){a.Ea&&g.Hf(a.Ea,function(c,d){g.Rk(b,d,c)});
a.D&&g.Dk({},function(c,d){g.Rk(b,d,c)})},V0a=function(a,b,c){c=Math.min(a.B.length,c);
var d=a.D?(0,g.Ta)(a.D.HS,a.D,a):null;a:for(var e=a.B,f=-1;;){var k=["count="+c];-1==f?0<c?(f=e[0].j,k.push("ofs="+f)):f=0:k.push("ofs="+f);for(var l=!0,m=0;m<c;m++){var n=e[m].j,p=e[m].map;n-=f;if(0>n)f=Math.max(0,e[m].j-100),l=!1;else try{Q0a(p,k,"req"+n+"_")}catch(r){d&&d(p)}}if(l){d=k.join("&");break a}}a=a.B.splice(0,c);b.ma=a;return d},K0a=function(a){a.j||a.N||(a.tb=1,g.Ii(a.VJ,a),a.ma=0)},g7=function(a){if(a.j||a.N||3<=a.ma)return!1;
a.tb++;a.N=S6((0,g.Ta)(a.VJ,a),T0a(a,a.ma));a.ma++;return!0},o7=function(a){null!=a.xa&&(g.C.clearTimeout(a.xa),a.xa=null)},X0a=function(a){a.j=new U6(a,a.C,"rpc",a.tb);
null===a.K&&(a.j.Ia=a.X);a.j.jb=0;var b=a.Wb.clone();g.Rk(b,"RID","rpc");g.Rk(b,"SID",a.C);g.Rk(b,"CI",a.bb?"0":"1");g.Rk(b,"AID",a.Oa);g.Rk(b,"TYPE","xmlhttp");p7(a,b);a.K&&a.X&&g.Yk(b,a.K,a.X);a.Va&&a.j.setTimeout(a.Va);var c=a.j;a=a.Db;c.Ja=1;c.K=l6(b.clone());c.N=null;c.ya=!0;B0a(c,a)},e7=function(a){null!=a.Z&&(g.C.clearTimeout(a.Z),a.Z=null)},H0a=function(a,b){var c=null;
if(a.j==b){e7(a);o7(a);a.j=null;var d=2}else if(d7(a.u,b))c=b.ma,J0a(a.u,b),d=1;else return;if(0!=a.qf)if(a.Eb=b.rb,b.B)if(1==d){c=b.N?b.N.length:0;b=Date.now()-b.oa;var e=a.oa;d=P6();d.dispatchEvent(new z0a(d,c,b,e));k7(a)}else K0a(a);else if(e=b.getLastError(),3==e||0==e&&0<a.Eb||!(1==d&&U0a(a,b)||2==d&&g7(a)))switch(c&&0<c.length&&(b=a.u,b.B=b.B.concat(c)),e){case 1:i7(a,5);break;case 4:i7(a,10);break;case 3:i7(a,6);break;default:i7(a,2)}},T0a=function(a,b){var c=a.od+Math.floor(Math.random()*
a.ke);
a.isActive()||(c*=2);return c*b},i7=function(a,b){if(2==b){var c=null;
a.D&&(c=null);var d=(0,g.Ta)(a.a_,a);c||(c=new g.Ek("//www.google.com/images/cleardot.gif"),g.C.location&&"http"==g.C.location.protocol||g.Fk(c,"https"),l6(c));O0a(c.toString(),d)}else R6(2);a.qf=0;a.D&&a.D.YJ(b);Y0a(a);S0a(a)},Y0a=function(a){a.qf=0;
a.rb=[];if(a.D){var b=l7(a.u);if(0!=b.length||0!=a.B.length)g.nc(a.rb,b),g.nc(a.rb,a.B),a.u.B.length=0,g.mc(a.B),a.B.length=0;a.D.XJ()}},Z0a=function(a){if(0==a.qf)return a.rb;
var b=[];g.nc(b,l7(a.u));g.nc(b,a.B);return b},I0a=function(a,b,c){var d=g.Sk(c);
""!=d.j?(b&&g.Gk(d,b+"."+d.j),g.Hk(d,d.u)):(d=g.C.location,d=Q_a(d.protocol,b?b+"."+d.hostname:d.hostname,+d.port,c));b=a.ya;c=a.Xc;b&&c&&g.Rk(d,b,c);g.Rk(d,"VER",a.UJ);p7(a,d);return d},C0a=function(a,b,c){if(b&&!a.Ja)throw Error("Can't create secondary domain capable XhrIo object.");
b=c&&a.fd&&!a.Wc?new g.Hj(new g.zk({RP:!0})):new g.Hj(a.Wc);b.K=a.Ja;return b},$0a=function(){},a1a=function(){if(g.Pc&&!g.Ic(10))throw Error("Environmental error: no available transport.");
...
b));this.C=new q7(this)},b1a=function(a){N6.call(this);
var b=a.__sm__;b?this.data=(this.metadataKey=g.Mf(b))?g.bg(b,this.metadataKey):b:this.data=a},c1a=function(a){O6.call(this);
this.status=1;this.errorCode=a},q7=function(a){this.j=a},s7=function(a){return new d1a(a,a.j)},d1a=function(a,b){this.u=a;
...
return g.C.setTimeout(function(){a()},b)},v7=function(a){u7.dispatchEvent(new f1a(u7,a))},f1a=function(a,b){g.xf.call(this,"statevent",a);
this.stat=b},w7=function(a,b,c,d){this.j=a;
this.C=b;this.K=c;this.J=d||1;this.u=45E3;this.B=new g.Zk(this);this.D=new g.Si;this.D.setInterval(250)},h1a=function(a,b,c){a.rs=1;
a.Cn=l6(b.clone());a.Mp=c;a.ya=!0;g1a(a,null)},x7=function(a,b,c,d,e){a.rs=1;
a.Cn=l6(b.clone());a.Mp=null;a.ya=c;e&&(a.DP=!1);g1a(a,d)},g1a=function(a,b){a.qs=Date.now();
y7(a);a.En=a.Cn.clone();m6(a.En,"t",a.J);a.lz=0;a.Nf=a.j.wD(a.j.Gv()?b:null);0<a.uD&&(a.jz=new K6((0,g.Ta)(a.bK,a,a.Nf),a.uD));a.B.Pa(a.Nf,"readystatechange",a.JS);b=a.Lp?g.dg(a.Lp):{};a.Mp?(a.kz="POST",b["Content-Type"]="application/x-www-form-urlencoded",a.Nf.send(a.En,a.kz,a.Mp,b)):(a.kz="GET",a.DP&&!g.Bf&&(b.Connection="close"),a.Nf.send(a.En,a.kz,null,b));a.j.Sj(1)},j1a=function(a,b){var c=a.lz,d=b.indexOf("\n",c);
if(-1==d)return z7;c=Number(b.substring(c,d));if(isNaN(c))return i1a;d+=1;if(d+c>b.length)return z7;b=b.substr(d,c);a.lz=d+c;return b},l1a=function(a,b){a.qs=Date.now();
...
a.u;
m1a(a,a.u)},m1a=function(a,b){if(null!=a.us)throw Error("WatchDog timer not null");
...
g.uf(a.jz);a.jz=null;a.D.stop();g.$k(a.B);if(a.Nf){var b=a.Nf;a.Nf=null;b.abort();b.dispose()}a.lk&&(a.lk=null)},E7=function(a,b){try{a.j.cK(a,b),a.j.Sj(4)}catch(c){}},o1a=function(a,b,c,d,e){if(0==d)c(!1);
...
this.u=new M6},q1a=function(a){var b=G7(a.j,a.Uv,"/mail/images/cleardot.gif");
l6(b);o1a(b.toString(),5E3,(0,g.Ta)(a.CT,a),3,2E3);a.Sj(1)},I7=function(a){var b=a.j.X;
if(null!=b)v7(5),b?(v7(11),H7(a.j,a,!1)):(v7(12),H7(a.j,a,!0));else if(a.Tg=new w7(a,void 0,void 0,void 0),a.Tg.Lp=a.xD,b=a.j,b=G7(b,b.Gv()?a.Fv:null,a.yD),v7(5),!g.Pc||g.Ic(10))m6(b,"TYPE","xmlhttp"),x7(a.Tg,b,!1,a.Fv,!1);else{m6(b,"TYPE","html");var c=a.Tg;a=!!a.Fv;c.rs=3;c.Cn=l6(b.clone());l1a(c,a)}},J7=function(a,b,c){this.j=1;
this.u=[];this.B=[];this.D=new M6;this.N=a||null;this.X=null!=b?b:null;this.K=c||!1},r1a=function(a,b){this.j=a;
this.map=b;this.context=null},s1a=function(a,b,c,d){g.xf.call(this,"timingevent",a);
this.size=b;this.xu=d},t1a=function(a){g.xf.call(this,"serverreachability",a)},u1a=function(a){a.KS(1,0);
a.nz=G7(a,null,a.zD);K7(a)},v1a=function(a){a.On&&(a.On.abort(),a.On=null);
a.Re&&(a.Re.cancel(),a.Re=null);a.Rl&&(g.C.clearTimeout(a.Rl),a.Rl=null);L7(a);a.gh&&(a.gh.cancel(),a.gh=null);a.Fn&&(g.C.clearTimeout(a.Fn),a.Fn=null)},w1a=function(a,b){if(0==a.j)throw Error("Invalid operation: sending map when state is closed");
a.u.push(new r1a(a.LS++,b));2!=a.j&&3!=a.j||K7(a)},x1a=function(a){var b=0;
a.Re&&b++;a.gh&&b++;return b},K7=function(a){a.gh||a.Fn||(a.Fn=t7((0,g.Ta)(a.gK,a),0),a.xs=0)},z1a=function(a,b){if(1==a.j){if(!b){a.Iv=Math.floor(1E5*Math.random());
b=a.Iv++;var c=new w7(a,"",b,void 0);c.Lp=a.Bk;var d=M7(a),e=a.nz.clone();g.Rk(e,"RID",b);g.Rk(e,"CVER","1");N7(a,e);h1a(c,e,d);a.gh=c;a.j=2}}else 3==a.j&&(b?y1a(a,b):0==a.u.length||a.gh||y1a(a))},y1a=function(a,b){if(b)if(6<a.Np){a.u=a.B.concat(a.u);
a.B.length=0;var c=a.Iv-1;b=M7(a)}else c=b.K,b=b.Mp;else c=a.Iv++,b=M7(a);var d=a.nz.clone();g.Rk(d,"SID",a.C);g.Rk(d,"RID",c);g.Rk(d,"AID",a.ys);N7(a,d);c=new w7(a,a.C,c,a.xs+1);c.Lp=a.Bk;c.setTimeout(1E4+Math.round(1E4*Math.random()));a.gh=c;h1a(c,d,b)},N7=function(a,b){a.Vf&&(a=a.Vf.kK())&&g.Hf(a,function(c,d){g.Rk(b,d,c)})},M7=function(a){var b=Math.min(a.u.length,1E3),c=["count="+b];
...
return c.join("&")},A1a=function(a){a.Re||a.Rl||(a.J=1,a.Rl=t7((0,g.Ta)(a.fK,a),0),a.ws=0)},O7=function(a){if(a.Re||a.Rl||3<=a.ws)return!1;
a.J++;a.Rl=t7((0,g.Ta)(a.fK,a),B1a(a,a.ws));a.ws++;return!0},H7=function(a,b,c){a.yC=c;
a.Ck=b.Ql;a.K||u1a(a)},L7=function(a){null!=a.Op&&(g.C.clearTimeout(a.Op),a.Op=null)},B1a=function(a,b){var c=5E3+Math.floor(1E4*Math.random());
a.isActive()||(c*=2);return c*b},P7=function(a,b){if(2==b||9==b){var c=null;
a.Vf&&(c=null);var d=(0,g.Ta)(a.ZZ,a);c||(c=new g.Ek("//www.google.com/images/cleardot.gif"),l6(c));n1a(c.toString(),1E4,d)}else v7(2);C1a(a,b)},C1a=function(a,b){a.j=0;
a.Vf&&a.Vf.hK(b);D1a(a);v1a(a)},D1a=function(a){a.j=0;
...
if(""!=d.j)b&&g.Gk(d,b+"."+d.j),g.Hk(d,d.u);else{var e=window.location;d=Q_a(e.protocol,b?b+"."+e.hostname:e.hostname,+e.port,c)}a.Hv&&g.Hf(a.Hv,function(f,k){g.Rk(d,k,f)});
g.Rk(d,"VER",a.Np);N7(a,d);return d},E1a=function(){},F1a=function(){this.j=[];
this.u=[]},G1a=function(){},I6=function(){if(!Q7){Q7=new g.Vi(new G1a);
...
e=void 0===e?!1:e;this.oa=a;this.K=b;this.B=new g.aq;this.u=new T7(this.CZ,this);this.j=null;this.Z=!1;this.J=null;this.X="";this.N=this.D=0;this.C=[];this.ya=c;this.ma=d;this.Ea=e;this.xa=new p0a;this.Ia=new q0a;this.Ja=new r0a},V7=function(a){if(a.j){var b=a.ma(),c=a.j.Bk||{};
...
this.Mc.subscribe("handlerMessage",this.OS,this);this.j=b},I1a=function(a,b,c){var d=this;
c=void 0===c?function(){return""}:c;
var e=void 0===e?new a1a:e;var f=void 0===f?new g.aq:f;this.pathPrefix=a;this.j=b;this.oa=c;this.D=f;this.N=null;this.J=this.X=this.K=0;this.B=new T7(function(){var k;d.B.isActive();0===(null===(k=d.channel)||void 0===k?void 0:h7(s7(k).j.u))&&d.connect(d.N,d.K)});
this.C={};this.u={};this.Z=!1;this.logger=null;this.ma=[];this.channel=null},K1a=function(a){g.mg(a.channel,"m",function(){a.J=3;
...
g.mg(a.channel,"n",function(){var b;a.J=0;a.B.isActive()||a.ea("webChannelClosed");var c=null===(b=a.channel)||void 0===b?void 0:e1a(s7(b));c&&(a.ma=[].concat(g.v(c)))});
g.mg(a.channel,"p",function(b){b=b.data;"gracefulReconnect"===b[0]?(a.B.start(),a.channel&&a.channel.close()):a.ea("webChannelMessage",new H1a(b[0],b[1]))});
g.mg(a.channel,"o",function(){J1a(a)||a.B.start();a.ea("webChannelError")})},J1a=function(a){var b;
...
this.j=a();this.j.subscribe("webChannelOpened",this.SS,this);this.j.subscribe("webChannelClosed",this.QS,this);this.j.subscribe("webChannelError",this.onError,this);this.j.subscribe("webChannelMessage",this.RS,this)},L1a=function(a,b,c,d,e){function f(){return new U7(X7(a,"/bc"),b,!1,c,d)}
c=void 0===c?function(){return""}:c;
...
var c=Q1a(a,String(b));g.gc(b8)?R1a(c):(O1a(),g.yc(b8,function(d){d(c)}))},N1a=function(){b8||(b8=g.Ka("yt.mdx.remote.debug.handlers_")||[],g.Ja("yt.mdx.remote.debug.handlers_",b8,void 0))},R1a=function(a){var b=(d8+1)%50;
...
this.u=a;this.j=NaN;i8(this);this.info("Initializing with "+u6(this.screens))},W1a=function(a){if(a.screens.length){var b=g.Vl(a.screens,function(d){return d.id}),c=X7(a.u,"/pairing/get_lounge_token_batch");
Y7(a.u,c,{screen_ids:b.join(",")},(0,g.Ta)(a.GU,a),(0,g.Ta)(a.FU,a))}},i8=function(a){if(g.P("deprecate_pair_servlet_enabled"))return U1a(a,[]);
var b=W_a(b0a());b=g.Pn(b,function(c){return!c.uuid});
return U1a(a,b)},k8=function(a,b){d0a(g.Vl(a.screens,U_a));
b&&c0a()},m8=function(a,b){g.Vv.call(this);
...
else{c=g.Pf(b);for(var d=0,e=c.length;d<e;++d)if(!a.j[c[d]]){c=!1;break a}c=!0}c||(l8("Updated online screens: "+g.oj(a.j)),a.j=b,a.ea("screenChange"));X1a(a)},p8=function(a){isNaN(a.B)||g.fs(a.B);
a.B=g.ds((0,g.Ta)(a.BH,a),0<a.C&&a.C<g.Xa()?2E4:1E4)},l8=function(a){c8("OnlineScreenService",a)},Y1a=function(a){var b={};
g.yc(a.J(),function(c){c.token?b[c.token]=c.id:this.De("Requesting availability of screen w/o lounge token.")});
return b},X1a=function(a){a=g.Pf(g.If(a.j,function(b){return b}));
...
c||(c=a.D[b]);var k=a.Nh(),l=c?x6(k,c):null;c&&(a.K||l)||(l=x6(k,b));if(l){l.uuid=b;var m=r8(a,l);n8(a.j,m,function(n){e(n?m:null)})}else c?$1a(a,c,(0,g.Ta)(function(n){var p=r8(this,new r6({name:d,
screenId:c,loungeToken:n,dialId:b||""}));n8(this.j,p,function(r){e(r?p:null)})},a),f):e(null)},b2a=function(a,b){for(var c=0,d=a.screens.length;c<d;++c)if(a.screens[c].name==b)return a.screens[c];
...
g.js(X7(a.C,"/pairing/get_lounge_token_batch"),e)},d2a=function(a){a.screens=a.u.Nh();
...
a.u=new j8(a.C);a.u.subscribe("screenChange",(0,g.Ta)(a.PU,a));d2a(a);a.K||(a.B=W_a(g.Mw("yt-remote-automatic-screen-cache")||[]));s8(a);a.info("Initializing automatic screens: "+u6(a.B));a.j=new m8(a.C,(0,g.Ta)(a.Nh,a,!0));a.j.subscribe("screenChange",(0,g.Ta)(function(){this.ea("onlineScreenChange")},a))},r8=function(a,b){var c=a.get(b.id);
c?(c.uuid=b.uuid,b=c):((c=x6(a.B,b.uuid))?(c.id=b.id,c.token=b.token,b=c):a.B.push(b),a.K||e2a(a));s8(a);a.D[b.uuid]=b.id;g.Lw("yt-remote-device-id-map",a.D,31536E3);return b},e2a=function(a){a=g.Pn(a.B,function(b){return"shortLived"!=b.idType});
g.Lw("yt-remote-automatic-screen-cache",g.Vl(a,U_a))},s8=function(a){a.D=g.Mw("yt-remote-device-id-map")||{}},t8=function(a,b,c){g.Vv.call(this);
...
var d=this;this.config_=c;this.u=null;this.ma=(0,g.Ta)(this.YS,this);this.xa=(0,g.Ta)(this.YY,this);this.Z=g.ds(function(){g2a(d,null)},12E4);
this.K=this.D=this.J=this.N=0;this.oa=!1;this.X="unknown"},x8=function(a,b){g.fs(a.K);
a.K=0;0==b?h2a(a):a.K=g.ds(function(){h2a(a)},b)},h2a=function(a){i2a(a,"getLoungeToken");
g.fs(a.D);a.D=g.ds(function(){j2a(a,null)},3E4)},i2a=function(a,b){a.info("sendYoutubeMessage_: "+b+" "+g.oj(void 0));
var c={};c.type=b;a.u?a.u.sendMessage("urn:x-cast:com.google.youtube.mdx",c,function(){},(0,g.Ta)(function(){v8(this,"Failed to send message: "+b+".")},a)):v8(a,"Sending yt message without session: "+g.oj(c))},y8=function(a,b){b?(a.info("onConnectedScreenId_: Received screenId: "+b),a.getScreen()&&a.getScreen().id==b||a.pM(b,function(c){u8(a,c)},function(){return a.Hg()},5)):a.Hg(Error("Waiting for session status timed out."))},l2a=function(a,b,c){a.info("onConnectedScreenData_: Received screenData: "+
JSON.stringify(b));
var d=new r6(b);k2a(a,d,function(e){e?(a.oa=!0,r8(a.B,d),u8(a,d),a.X="unknown",x8(a,c)):(g.Or(Error("CastSession, RemoteScreen from screenData: "+JSON.stringify(b)+" is not online.")),a.Hg())},5)},g2a=function(a,b){g.fs(a.Z);
...
".")),y8(a,b.screenId)):y8(a,b.screenId):a.Hg(Error("Waiting for session status timed out."))},j2a=function(a,b){g.fs(a.D);
a.D=0;var c=null;if(b)if(b.loungeToken){var d;(null==(d=a.getScreen())?void 0:d.token)==b.loungeToken&&(c="staleLoungeToken")}else c="missingLoungeToken";else c="noLoungeTokenResponse";c?(a.info("Did not receive a new lounge token in onLoungeToken_ with data: "+(JSON.stringify(b)+", error: "+c)),a.X=c,x8(a,3E4)):(f2a(a,b.loungeToken),a.oa=!1,a.X="unknown",x8(a,b.loungeTokenRefreshIntervalMs))},k2a=function(a,b,c,d){g.fs(a.J);
a.J=0;c2a(a.B,b,function(e){e||0>d?c(e):a.J=g.ds(function(){k2a(a,b,c,d-1)},300)})},m2a=function(a){g.fs(a.N);
...
return!!(a.config_.enableDialLoungeToken&&(null==(b=a.u)?0:b.getDialAppInfo))},n2a=function(a){a.D=a.B.mK(a.xa,a.j.label,a.j.friendlyName,A8(a),function(b,c){a.D=function(){};
a.ma=!0;u8(a,b);"shortLived"==b.idType&&0<c&&B8(a,c)},function(b){a.D=function(){};
a.Hg(b)})},o2a=function(a){var b={};
b.pairingCode=a.xa;b.theme=a.Ja;f0a()&&(b.env_useStageMdx=1);return g.Bj(b)},C8=function(a){return new Promise(function(b){a.xa=v6();
if(a.Ia){var c=new chrome.cast.DialLaunchResponse(!0,o2a(a));b(c);n2a(a)}else a.Z=function(){g.fs(a.X);a.Z=function(){};
a.X=NaN;var d=new chrome.cast.DialLaunchResponse(!0,o2a(a));b(d);n2a(a)},a.X=g.ds(function(){a.Z()},100)})},q2a=function(a,b,c){a.info("initOnConnectedScreenDataPromise_: Received screenData: "+JSON.stringify(b));
var d=new r6(b);return(new Promise(function(e){p2a(a,d,function(f){f?(a.ma=!0,r8(a.B,d),u8(a,d),B8(a,c)):g.Or(Error("DialSession, RemoteScreen from screenData: "+JSON.stringify(b)+" is not online."));e(f)},5)})).then(function(e){return e?new chrome.cast.DialLaunchResponse(!1):C8(a)})},r2a=function(a,b){var c=a.N.receiver.label,d=a.j.friendlyName;
return(new Promise(function(e){a2a(a.B,c,b,d,function(f){f&&f.token&&u8(a,f);e(f)},function(f){v8(a,"Failed to get DIAL screen: "+f);
e(null)})})).then(function(e){return e&&e.token?new chrome.cast.DialLaunchResponse(!1):C8(a)})},p2a=function(a,b,c,d){g.fs(a.J);
a.J=0;c2a(a.B,b,function(e){e||0>d?c(e):a.J=g.ds(function(){p2a(a,b,c,d-1)},300)})},B8=function(a,b){a.info("getDialAppInfoWithTimeout_ "+b);
A8(a)&&(g.fs(a.K),a.K=0,0==b?s2a(a):a.K=g.ds(function(){s2a(a)},b))},s2a=function(a){A8(a)&&a.u.getDialAppInfo(function(b){a.info("getDialAppInfo dialLaunchData: "+JSON.stringify(b));
b=b.extraData||{};var c=null;if(b.loungeToken){var d;(null==(d=a.getScreen())?void 0:d.token)==b.loungeToken&&(c="staleLoungeToken")}else c="missingLoungeToken";c?(a.oa=c,B8(a,3E4)):(a.ma=!1,a.oa="unknown",f2a(a,b.loungeToken),B8(a,b.loungeTokenRefreshIntervalMs))},function(b){a.info("getDialAppInfo error: "+b);
a.oa="noLoungeTokenResponse";B8(a,3E4)})},t2a=function(a){g.fs(a.J);
...
this.config_=b;this.u=a;this.N=b.appId||"233637DE";this.C=b.theme||"cl";this.X=b.disableCastApi||!1;this.J=b.forceMirroring||!1;this.j=null;this.K=!1;this.B=[];this.D=(0,g.Ta)(this.TX,this)},u2a=function(a,b){return b?g.$b(a.B,function(c){return s6(b,c.label)},a):null},F8=function(a){c8("Controller",a)},M1a=function(a){window.chrome&&chrome.cast&&chrome.cast.logMessage&&chrome.cast.logMessage(a)},G8=function(a){return a.K||!!a.B.length||!!a.j},H8=function(a,b,c){b!=a.j&&(g.uf(a.j),(a.j=b)?(c?a.ea("yt-remote-cast2-receiver-resumed",
b.j):a.ea("yt-remote-cast2-receiver-selected",b.j),b.subscribe("sessionScreen",(0,g.Ta)(a.HO,a,b)),b.subscribe("sessionFailed",function(){return v2a(a,b)}),b.getScreen()?a.ea("yt-remote-cast2-session-change",b.getScreen()):c&&a.j.Qt(null)):a.ea("yt-remote-cast2-session-change",null))},v2a=function(a,b){a.j==b&&a.ea("yt-remote-cast2-session-failed")},w2a=function(a){var b=a.u.lK(),c=a.j&&a.j.j;
a=g.Vl(b,function(d){c&&s6(d,c.label)&&(c=null);var e=d.uuid?d.uuid:d.id,f=u2a(this,d);f?(f.label=e,f.friendlyName=d.name):(f=new chrome.cast.Receiver(e,d.name),f.receiverType=chrome.cast.ReceiverType.CUSTOM);return f},a);
c&&(c.receiverType!=chrome.cast.ReceiverType.CUSTOM&&(c=new chrome.cast.Receiver(c.label,c.friendlyName),c.receiverType=chrome.cast.ReceiverType.CUSTOM),a.push(c));return a},B2a=function(a,b,c,d){d.disableCastApi?I8("Cannot initialize because disabled by Mdx config."):x2a()?y2a(b,d)&&(J8(!0),window.chrome&&chrome.cast&&chrome.cast.isAvailable?z2a(a,c):(window.__onGCastApiAvailable=function(e,f){e?z2a(a,c):(K8("Failed to load cast API: "+f),L8(!1),J8(!1),g.Nw("yt-remote-cast-available"),g.Nw("yt-remote-cast-receiver"),
A2a(),c(!1))},d.loadCastApiSetupScript?g.Pw("https://www.gstatic.com/cv/js/sender/v1/cast_sender.js"):0<=window.navigator.userAgent.indexOf("Android")&&0<=window.navigator.userAgent.indexOf("Chrome/")&&window.navigator.presentation?60<=E6()&&m0a():!window.chrome||!window.navigator.presentation||0<=window.navigator.userAgent.indexOf("Edge")?G6():89<=E6()?o0a():(H6(),F6(n0a.map(j0a))))):I8("Cannot initialize because not running Chrome")},A2a=function(){I8("dispose");
var a=M8();a&&a.dispose();g.Ja("yt.mdx.remote.cloudview.instance_",null,void 0);C2a(!1);g.rt(N8);N8.length=0},O8=function(){return!!g.Mw("yt-remote-cast-installed")},D2a=function(){var a=g.Mw("yt-remote-cast-receiver");
return a?a.friendlyName:null},E2a=function(){I8("clearCurrentReceiver");
g.Nw("yt-remote-cast-receiver")},F2a=function(){return O8()?M8()?M8().getCastSession():(K8("getCastSelector: Cast is not initialized."),null):(K8("getCastSelector: Cast API is not installed!"),null)},Q8=function(){O8()?M8()?P8()?(I8("Requesting cast selector."),M8().requestSession()):(I8("Wait for cast API to be ready to request the session."),N8.push(g.qt("yt-remote-cast2-api-ready",Q8))):K8("requestCastSelector: Cast is not initialized."):K8("requestCastSelector: Cast API is not installed!")},R8=
function(a,b){P8()?M8().setConnectedScreenStatus(a,b):K8("setConnectedScreenStatus called before ready.")},x2a=function(){var a=0<=g.Ab().search(/ (CrMo|Chrome|CriOS)\//);
return g.OA||a},G2a=function(a,b){M8().init(a,b)},y2a=function(a,b){var c=!1;
...
J8(!1);G2a(a,function(c){c?(C2a(!0),g.tt("yt-remote-cast2-api-ready")):(K8("Failed to initialize cast API."),L8(!1),g.Nw("yt-remote-cast-available"),g.Nw("yt-remote-cast-receiver"),A2a());b(c)})},I8=function(a){c8("cloudview",a)},K8=function(a){c8("cloudview",a)},L8=function(a){I8("setCastInstalled_ "+a);
g.Lw("yt-remote-cast-installed",a)},P8=function(){return!!g.Ka("yt.mdx.remote.cloudview.apiReady_")},C2a=function(a){I8("setApiReady_ "+a);
...
this.B=0;this.C=a;this.J=[];this.D=new F1a;this.u=this.j=null;this.X=(0,g.Ta)(this.FW,this);this.K=(0,g.Ta)(this.Bx,this);this.N=(0,g.Ta)(this.EW,this);this.Z=(0,g.Ta)(this.IW,this);var c=0;a?(c=a.getProxyState(),3!=c&&(a.subscribe("proxyStateChange",this.SH,this),H2a(this))):c=3;0!=c&&(b?this.SH(c):g.ds((0,g.Ta)(function(){this.SH(c)},this),0));
(a=F2a())&&Z8(this,a);this.subscribe("yt-remote-cast2-session-change",this.Z)},a9=function(a){return new S8(a.C.getPlayerContextData())},H2a=function(a){g.yc("nowAutoplaying autoplayDismissed remotePlayerChange remoteQueueChange autoplayModeChange autoplayUpNext previousNextChange multiStateLoopEnabled loopModeChange".split(" "),function(b){this.J.push(this.C.subscribe(b,g.Wa(this.RX,b),this))},a)},I2a=function(a){g.yc(a.J,function(b){this.C.unsubscribeByKey(b)},a);
...
a.C.setPlayerContextData(Y8(b));H2a(a)},Z8=function(a,b){a.u&&(a.u.removeUpdateListener(a.X),a.u.removeMediaListener(a.K),a.Bx(null));
a.u=b;a.u&&(c8("CP","Setting cast session: "+a.u.sessionId),a.u.addUpdateListener(a.X),a.u.addMediaListener(a.K),a.u.media.length&&a.Bx(a.u.media[0]))},J2a=function(a){var b=a.j.media,c=a.j.customData;
...
this.B=[];this.j=new S8;this.Ja=b.id;this.ya=b.idType;this.u=L1a(this.Ia,c,this.hJ,"shortLived"==this.ya,this.Ja);this.u.Pa("channelOpened",function(){K2a(e)});
...
this.u.Pa("channelMessage",function(f){L2a(e,f)});
this.u.hn(b.token);this.subscribe("remoteQueueChange",function(){var f=e.j.videoId;g.Ow()&&g.Lw("yt-remote-session-video-id",f)})},M2a=function(a){return g.$b(a.B,function(b){return"LOUNGE_SCREEN"==b.type})},h9=function(a){c8("conn",a)},i9=function(a,b){a.ea("proxyStateChange",b)},N2a=function(a){a.J=g.ds(function(){h9("Connecting timeout");
...
a.xa&&(a.xa=!1,l9(a),a.oa=g.ds(function(){h9("Timing out waiting for a screen.");a.Zs(1)},15E3))},Q2a=function(a,b){var c=null;
if(b){var d=M2a(a);d&&(c={clientName:d.clientName,deviceMake:d.brand,deviceModel:d.model,osVersion:d.osVersion})}g.Ja("yt.mdx.remote.remoteClient_",c,void 0);b&&(k9(a),l9(a));c=a.u.Jt()&&isNaN(a.J);b==c?b&&(i9(a,1),n9(a,"getSubtitlesTrack")):b?(a.oM()&&a.j.reset(),i9(a,1),n9(a,"getNowPlaying"),P2a(a)):a.Zs(1)},R2a=function(a,b){var c=b.params.videoId;
delete b.params.videoId;c==a.j.videoId&&(g.Zf(b.params)?a.j.trackData=null:a.j.trackData=b.params,a.ea("remotePlayerChange"))},S2a=function(a,b,c){var d=b.params.videoId||b.params.video_id,e=parseInt(b.params.currentIndex,10);
...
Q2a(a,b);b=a.WM("mlm");a.ea("multiStateLoopEnabled",b);break;case "loungeScreenDisconnected":g.kc(a.B,function(d){return"LOUNGE_SCREEN"==d.type});
Q2a(a,!1);break;case "remoteConnected":var c=new q6(o6(b.params.device));g.$b(a.B,function(d){return d.equals(c)})||O_a(a.B,c);
...
break;case "requestAssistedSignIn":a.ea("assistedSignInRequested",b.params.authCode);break;case "onLoopModeChanged":a.ea("loopModeChange",b.params.loopMode);break;default:h9("Unrecognized action: "+b.action)}},P2a=function(a){g.fs(a.X);
...
this.Ze=a;this.j=[];this.j.push(this.Ze.$_s("screenChange",(0,g.Ta)(this.gR,this)));this.j.push(this.Ze.$_s("onlineScreenChange",(0,g.Ta)(this.yX,this)))},d3a=function(a,b){e0a();
if(!D6||!D6.get("yt-remote-disable-remote-module-for-dev")){b=g.O("MDX_CONFIG")||b;Y_a();B6();p9||(p9=new W7(b?b.loungeApiHost:void 0),f0a()&&(p9.j="/api/loungedev"));q9||(q9=g.Ka("yt.mdx.remote.deferredProxies_")||[],g.Ja("yt.mdx.remote.deferredProxies_",q9,void 0));a3a();var c=r9();if(!c){var d=new q8(p9,b?b.disableAutomaticScreenCache||!1:!1);g.Ja("yt.mdx.remote.screenService_",d,void 0);c=r9();var e={};b&&(e={appId:b.appId,disableDial:b.disableDial,theme:b.theme,loadCastApiSetupScript:b.loadCastApiSetupScript,
disableCastApi:b.disableCastApi,enableDialLoungeToken:b.enableDialLoungeToken,enableCastLoungeToken:b.enableCastLoungeToken,forceMirroring:b.forceMirroring});g.Ja("yt.mdx.remote.enableConnectWithInitialState_",b?b.enableConnectWithInitialState||!1:!1,void 0);B2a(a,d,function(f){f?s9()&&R8(s9(),"YouTube TV"):d.subscribe("onlineScreenChange",function(){p6("yt-remote-receiver-availability-change")})},e)}b&&!g.Ka("yt.mdx.remote.initialized_")&&(g.Ja("yt.mdx.remote.initialized_",!0,void 0),t9("Initializing: "+
...
p6("yt-remote-auto-connect","cast-selector-receiver")})),u9.push(g.qt("yt-remote-cast2-receiver-resumed",function(){p6("yt-remote-receiver-resumed","cast-selector-receiver")})),u9.push(g.qt("yt-remote-cast2-session-change",b3a)),u9.push(g.qt("yt-remote-connection-change",function(f){f?R8(s9(),"YouTube TV"):w9()||(R8(null,null),E2a())})),u9.push(g.qt("yt-remote-cast2-session-failed",function(){p6("yt-remote-connection-failed")})),a=x9(),b.isAuto&&(a.id+="#dial"),e=b.capabilities||[],g.P("desktop_enable_autoplay")&&
e.push("atp"),0<e.length&&(a.capabilities=e),a.name=b.device,a.app=b.app,(b=b.theme)&&(a.theme=b),t9(" -- with channel params: "+g.oj(a)),a?(g.Lw("yt-remote-session-app",a.app),g.Lw("yt-remote-session-name",a.name)):(g.Nw("yt-remote-session-app"),g.Nw("yt-remote-session-name")),g.Ja("yt.mdx.remote.channelParams_",a,void 0),c.start(),s9()||c3a())}},e3a=function(){var a=r9().Ze.$_gos();
var b=y9();b&&z9()&&(w6(a,b)||a.push(b));return X_a(a)},A9=function(){var a=f3a();
...
if(!a)return null;var b=r9().Nh();return x6(b,a)},b3a=function(a){t9("remote.onCastSessionChange_: "+t6(a));
...
y9()&&y9();if(H9)B9=a;else{g3a(a.id);var c=g.Ka("yt.mdx.remote.enableConnectWithInitialState_")||!1;a=new j9(p9,a,x9(),c);a.connect(b,h3a());a.subscribe("beforeDisconnect",function(d){p6("yt-remote-before-disconnect",d)});
...
a?(t9("Resume connection to: "+t6(a)),D9(a,0)):(C6(),E2a(),t9("Skipping connecting because no session screen found."))},a3a=function(){var a=x9();
...
var d=this;this.u=a;this.I=b;this.dc=c;this.events=new g.KA(this);this.Z=this.events.T(this.I,"onVolumeChange",function(e){i3a(d,e)});
...
a=this.dc;a.isDisposed();a.subscribe("proxyStateChange",this.EO,this);a.subscribe("remotePlayerChange",this.Fx,this);a.subscribe("remoteQueueChange",this.wB,this);a.subscribe("previousNextChange",this.BO,this);a.subscribe("nowAutoplaying",this.vO,this);a.subscribe("autoplayDismissed",this.YN,this);g.K(this,this.j);g.K(this,this.B);g.K(this,this.N);g.K(this,this.X);g.K(this,this.K);this.WP();this.wB();this.Fx()},i3a=function(a,b){if(J9(a)){a.dc.unsubscribe("remotePlayerChange",a.Fx,a);
var c=Math.round(b.volume);b=!!b.muted;var d=a9(a.dc);if(c!==d.volume||b!==d.muted)a.dc.setVolume(c,b),a.X.start();a.dc.subscribe("remotePlayerChange",a.Fx,a)}},j3a=function(a){a.Vb(0);
...
if(null===c||void 0===c?0:c.listId){var d=c.index;var e=c.listId.toString()}c=a.I.getVideoData(1);a.dc.playVideo(c.videoId,b,d,e,c.playerParams,c.Ya,N_a(c));a.hc(new g.WH(1))},k3a=function(a,b){if(b){var c=a.I.getOption("captions","tracklist",{MM:1});
...
L:"ytp-mdx-popup-dialog",W:{role:"dialog"},U:[{G:"div",L:"ytp-mdx-popup-dialog-inner-content",U:[{G:"div",L:"ytp-mdx-popup-title",qa:"You're signed out"},{G:"div",L:"ytp-mdx-popup-description",qa:"Videos that you watch may be added to the TV's watch history and influence TV recommendations. To avoid this, cancel and sign in to YouTube on your computer."},{G:"div",L:"ytp-mdx-privacy-popup-buttons",U:[{G:"button",Ha:["ytp-button","ytp-mdx-privacy-popup-cancel"],qa:"Cancel"},{G:"button",Ha:["ytp-button",
...
L:"ytp-remote",U:[{G:"div",L:"ytp-remote-display-status",U:[{G:"div",L:"ytp-remote-display-status-icon",U:[g.iAa()]},{G:"div",L:"ytp-remote-display-status-text",qa:"{{statustext}}"}]}]});this.api=a;this.j=new g.DJ(this,250);g.K(this,this.j);this.T(a,"presentingplayerstatechange",this.onStateChange);l3a(this,a.zb())},l3a=function(a,b){if(3===a.api.getPresentingPlayerType()){var c={RECEIVER_NAME:a.api.getOption("remote","currentReceiver").name};
...
var i_a=g.Ve(function(a,b,c){if(1!==a.u)return!1;g.D(b,c,g.rd(a));return!0},g.Ze),A_a=g.Ve(function(a,b,c,d){if(1!==a.u)return!1;
g.be(b,c,d,g.rd(a));return!0},g.Ze),j_a=g.Ve(function(a,b,c){if(0!==a.u)return!1;
g.D(b,c,g.fd(a.j));return!0},g.$e),z_a=g.Ve(function(a,b,c,d){if(0!==a.u)return!1;
g.be(b,c,d,g.fd(a.j));return!0},g.$e),r_a=g.Ve(function(a,b,c){if(0!==a.u)return!1;
g.D(b,c,g.gd(a.j));return!0},g.af),w_a=g.Ve(function(a,b,c,d){if(0!==a.u)return!1;
g.be(b,c,d,g.gd(a.j));return!0},g.af),E_a=g.Ve(function(a,b,c){if(1!==a.u)return!1;
g.D(b,c,a.j.D());return!0},function(a,b,c){b_a(a,c,g.Rd(b,c))}),G_a=g.Ve(function(a,b,c){if(1!==a.u&&2!==a.u)return!1;
...
if(null!=b)for(var d=0;d<b.length;d++)b_a(a,c,b[d])}),o_a=g.Ve(function(a,b,c){if(0!==a.u)return!1;
g.D(b,c,g.id(a.j));return!0},c_a),x_a=g.Ve(function(a,b,c,d){if(0!==a.u)return!1;
g.be(b,c,d,g.id(a.j));return!0},c_a),F_a=g.Ve(function(a,b,c){if(2!==a.u)return!1;
a=g.td(a);g.$d(b,c,a);return!0},function(a,b,c){b=g.Td(b,c);
if(null!=b)for(var d=0;d<b.length;d++){var e=b[d];null!=e&&g.Ed(a,c,g.ib(e))}}),v_a=g.Ve(function(a,b,c,d){if(2!==a.u)return!1;
g.be(b,c,d,g.td(a));return!0},g.bf),C_a=g.Ve(function(a,b,c,d,e){if(2!==a.u)return!1;
g.qd(a,g.ce(b,d,c),e);return!0},g.cf),f_a=[1];
g.w(g_a,g.F);g.w(h_a,g.F);g.w(m_a,g.F);g.w(n_a,g.F);var t_a=[1,2];g.w(q_a,g.F);var k1a={"\x00":"\\0","\b":"\\b","\f":"\\f","\n":"\\n","\r":"\\r","\t":"\\t","\v":"\\x0B",'"':'\\"',"\\":"\\\\","<":"\\u003C"},C7={"'":"\\'"},T_a={V0:"atp",uda:"ska",aca:"que",J$:"mus",tda:"sus",u6:"dsp",yca:"seq",m$:"mic",p5:"dpa",n1:"cds",H$:"mlm",m5:"dsdtr",saa:"ntb"};q6.prototype.equals=function(a){return a?this.id==a.id:!1};
var D6,z6="",l0a=g0a("loadCastFramework")||g0a("loadCastApplicationFramework"),n0a=["pkedcjkdefgpdelpbcmbmeomcjbeemfm","enhhojjnijigcajfphajepfemndkmdlo"];/*
...
M6.prototype.parse=function(a){return g.C.JSON.parse(a,void 0)};g.Ya(N6,g.xf);g.Ya(O6,g.xf);var u0a=!1;var w0a=null;g.Ya(x0a,g.xf);g.Ya(y0a,g.xf);g.Ya(z0a,g.xf);T6.prototype.info=function(){};
...
1E3}else d=1E3;d=V0a(this,b,d);e=this.Ia.clone();g.Rk(e,"RID",a);g.Rk(e,"CVER",22);this.ya&&g.Rk(e,"X-HTTP-Session-Id",this.ya);p7(this,e);c&&(this.jb?d="headers="+g.Ih(g.Ida(c))+"&"+d:this.K&&g.Yk(e,this.K,c));j7(this.u,b);this.le&&g.Rk(e,"TYPE","init");this.kb?(g.Rk(e,"$req",d),g.Rk(e,"SID","null"),b.tb=!0,V6(b,e,null)):V6(b,e,d);this.qf=2}}else 3==this.qf&&(a?W0a(this,a):0==this.B.length||N0a(this.u)||W0a(this))};
g.h.VJ=function(){this.N=null;X0a(this);if(this.Sb&&!(this.Ya||null==this.j||0>=this.Ub)){var a=2*this.Ub;this.xa=S6((0,g.Ta)(this.zW,this),a)}};
g.h.zW=function(){this.xa&&(this.xa=null,null!=this.j.j&&g.Nj(this.j.j),this.bb=!1,this.Ya=!0,R6(10),f7(this),X0a(this))};
...
g.h=$0a.prototype;g.h.aK=function(){};
g.h.ZJ=function(){};
g.h.YJ=function(){};
g.h.XJ=function(){};
...
r7.prototype.send=function(a){var b=this.j;if("string"===typeof a){var c={};c.__data__=a;a=c}else this.D&&(c={},c.__data__=g.oj(a),a=c);b.B.push(new L0a(b.Qd++,a));3==b.qf&&k7(b)};
r7.prototype.va=function(){this.j.D=null;delete this.C;this.j.disconnect();delete this.j;r7.re.va.call(this)};
g.Ya(b1a,N6);g.Ya(c1a,O6);g.Ya(q7,$0a);q7.prototype.aK=function(){this.j.dispatchEvent("m")};
q7.prototype.ZJ=function(a){this.j.dispatchEvent(new b1a(a))};
q7.prototype.YJ=function(a){this.j.dispatchEvent(new c1a(a))};
q7.prototype.XJ=function(){this.j.dispatchEvent("n")};var u7=new g.xg;g.w(f1a,g.xf);g.h=w7.prototype;g.h.Lp=null;g.h.Pl=!1;g.h.us=null;g.h.vD=null;g.h.qs=null;g.h.rs=null;g.h.Cn=null;g.h.En=null;g.h.Mp=null;g.h.Nf=null;g.h.lz=0;g.h.lk=null;g.h.kz=null;g.h.Dn=null;g.h.Ev=-1;g.h.DP=!0;g.h.Kp=!1;g.h.uD=0;g.h.jz=null;var i1a={},z7={};g.h=w7.prototype;g.h.setTimeout=function(a){this.u=a};
g.h.JS=function(a){a=a.target;var b=this.jz;b&&3==g.Kj(a)?b.tD():this.bK(a)};
g.h.bK=function(a){try{if(a==this.Nf)a:{var b=g.Kj(this.Nf),c=this.Nf.u,d=this.Nf.getStatus();if(g.Pc&&!g.Ic(10)||g.Bf&&!g.Hc("420+")){if(4>b)break a}else if(3>b||3==b&&!g.Nj(this.Nf))break a;this.Kp||4!=b||7==c||(8==c||0>=d?this.j.Sj(3):this.j.Sj(2));D7(this);var e=this.Nf.getStatus();this.Ev=e;var f=g.Nj(this.Nf);if(this.Pl=200==e){4==b&&A7(this);if(this.ya){for(a=!0;!this.Kp&&this.lz<f.length;){var k=j1a(this,f);if(k==z7){4==b&&(this.Dn=4,v7(15),a=!1);break}else if(k==i1a){this.Dn=4;v7(16);a=!1;
...
g.h.IS=function(){this.us=null;var a=Date.now();0<=a-this.vD?(2!=this.rs&&this.j.Sj(3),A7(this),this.Dn=2,v7(18),B7(this)):m1a(this,this.vD-a)};
g.h.getLastError=function(){return this.Dn};g.h=p1a.prototype;g.h.xD=null;g.h.Tg=null;g.h.RB=!1;g.h.QP=null;g.h.aA=null;g.h.gG=null;g.h.yD=null;g.h.zi=null;g.h.Ql=-1;g.h.Fv=null;g.h.Uv=null;g.h.connect=function(a){this.yD=a;a=G7(this.j,null,this.yD);v7(3);this.QP=Date.now();var b=this.j.N;null!=b?(this.Fv=b[0],(this.Uv=b[1])?(this.zi=1,q1a(this)):(this.zi=2,I7(this))):(m6(a,"MODE","init"),this.Tg=new w7(this,void 0,void 0,void 0),this.Tg.Lp=this.xD,x7(this.Tg,a,!1,null,!0),this.zi=0)};
...
g.h.mz=function(){this.Ql=this.Tg.Ev;if(this.Tg.Pl)0==this.zi?this.Uv?(this.zi=1,q1a(this)):(this.zi=2,I7(this)):2==this.zi&&((!g.Pc||g.Ic(10)?!this.RB:200>this.gG-this.aA)?(v7(11),H7(this.j,this,!1)):(v7(12),H7(this.j,this,!0)));else{0==this.zi?v7(9):2==this.zi&&v7(10);var a=this.j;this.Tg.getLastError();a.Ck=this.Ql;P7(a,2)}};
g.h.Gv=function(){return this.j.Gv()};
g.h.isActive=function(){return this.j.isActive()};
g.h.Sj=function(a){this.j.Sj(a)};g.h=J7.prototype;g.h.Bk=null;g.h.Hv=null;g.h.gh=null;g.h.Re=null;g.h.zD=null;g.h.nz=null;g.h.dK=null;g.h.oz=null;g.h.Iv=0;g.h.LS=0;g.h.Vf=null;g.h.Fn=null;g.h.Rl=null;g.h.Op=null;g.h.On=null;g.h.yC=null;g.h.ys=-1;g.h.eK=-1;g.h.Ck=-1;g.h.xs=0;g.h.ws=0;g.h.Np=8;g.Ya(s1a,g.xf);g.Ya(t1a,g.xf);g.h=J7.prototype;g.h.connect=function(a,b,c,d,e){v7(0);this.zD=b;this.Hv=c||{};d&&void 0!==e&&(this.Hv.OSID=d,this.Hv.OAID=e);this.K?(t7((0,g.Ta)(this.xL,this,a),100),u1a(this)):this.xL(a)};
g.h.disconnect=function(){v1a(this);if(3==this.j){var a=this.Iv++,b=this.nz.clone();g.Rk(b,"SID",this.C);g.Rk(b,"RID",a);g.Rk(b,"TYPE","terminate");N7(this,b);a=new w7(this,this.C,a,void 0);a.rs=2;a.Cn=l6(b.clone());e_a(new Image,a.Cn.toString());a.qs=Date.now();y7(a)}D1a(this)};
g.h.xL=function(a){this.On=new p1a(this);this.On.xD=this.Bk;this.On.u=this.D;this.On.connect(a)};
g.h.cf=function(){return 0==this.j};
g.h.getState=function(){return this.j};
g.h.gK=function(a){this.Fn=null;z1a(this,a)};
g.h.fK=function(){this.Rl=null;this.Re=new w7(this,this.C,"rpc",this.J);this.Re.Lp=this.Bk;this.Re.uD=0;var a=this.dK.clone();g.Rk(a,"RID","rpc");g.Rk(a,"SID",this.C);g.Rk(a,"CI",this.yC?"0":"1");g.Rk(a,"AID",this.ys);N7(this,a);if(!g.Pc||g.Ic(10))g.Rk(a,"TYPE","xmlhttp"),x7(this.Re,a,!0,this.oz,!1);else{g.Rk(a,"TYPE","html");var b=this.Re,c=!!this.oz;b.rs=3;b.Cn=l6(a.clone());l1a(b,c)}};
...
g.h.ZZ=function(a){a?v7(2):(v7(1),C1a(this,8))};
...
g.h.Sj=function(a){var b=u7;b.dispatchEvent(new t1a(b,a))};
g.h.Gv=function(){return!(!g.Pc||g.Ic(10))};
g.h=E1a.prototype;g.h.jK=function(){};
g.h.iK=function(){};
g.h.hK=function(){};
g.h.AD=function(){};
...
g.h.Ji=function(){for(var a=[],b=this.j.length-1;0<=b;--b)a.push(this.j[b]);var c=this.u.length;for(b=0;b<c;++b)a.push(this.u[b]);return a};G1a.prototype.flush=function(a,b){a=void 0===a?[]:a;b=void 0===b?!1:b;if(g.P("enable_client_streamz_web")){a=g.q(a);for(var c=a.next();!c.done;c=a.next())c=g.Zba(c.value),c={serializedIncrementBatch:g.Lc(g.Re(c,H_a))},g.$t("streamzIncremented",c,{MH:b})}};var Q7;g.w(R7,g.xf);g.w(S7,g.xf);g.Ya(T7,g.I);g.h=T7.prototype;g.h.FY=function(){this.fg=Math.min(3E5,2*this.fg);this.B();this.u&&this.start()};
g.h.start=function(){var a=this.fg+15E3*Math.random();g.yp(this.j,a);this.u=Date.now()+a};
g.h.stop=function(){this.j.stop();this.u=0};
g.h.isActive=function(){return this.j.isActive()};
g.h.reset=function(){this.j.stop();this.fg=5E3};g.Ya(U7,E1a);g.h=U7.prototype;g.h.subscribe=function(a,b,c){return this.B.subscribe(a,b,c)};
...
g.h.connect=function(a,b,c){if(!this.j||2!=this.j.getState()){this.X="";this.u.stop();this.J=a||null;this.D=b||0;a=this.oa+"/test";b=this.oa+"/bind";var d=new J7(c?c.firstTestResults:null,c?c.secondTestResults:null,this.ya),e=this.j;e&&(e.Vf=null);d.Vf=this;this.j=d;V7(this);if(this.j){d=g.O("ID_TOKEN");var f=this.j.Bk||{};d?f["x-youtube-identity-token"]=d:delete f["x-youtube-identity-token"];this.j.Bk=f}e?(3!=e.getState()&&0==x1a(e)||e.getState(),this.j.connect(a,b,this.K,e.C,e.ys)):c?this.j.connect(a,
b,this.K,c.sessionId,c.arrayId):this.j.connect(a,b,this.K)}};
g.h.disconnect=function(a){this.N=a||0;this.u.stop();V7(this);this.j&&(3==this.j.getState()&&z1a(this.j),this.j.disconnect());this.N=0};
g.h.sendMessage=function(a,b){a={_sc:a};b&&g.gg(a,b);this.u.isActive()||2==(this.j?this.j.getState():0)?this.C.push(a):this.Jt()&&(V7(this),w1a(this.j,a))};
g.h.jK=function(){this.u.reset();this.J=null;this.D=0;if(this.C.length){var a=this.C;this.C=[];for(var b=0,c=a.length;b<c;++b)w1a(this.j,a[b])}this.ea("handlerOpened")};
...
g.h.iK=function(a){"S"==a[0]?this.X=a[1]:"gracefulReconnect"==a[0]?(this.u.start(),this.j.disconnect()):this.ea("handlerMessage",new H1a(a[0],a[1]))};
...
g.h.CZ=function(){this.u.isActive();0==x1a(this.j)&&this.connect(this.J,this.D)};W7.prototype.C=function(a,b,c,d){b?a(d):a({text:c.responseText})};
...
g.h.PS=function(){this.dispatchEvent("channelOpened");var a=this.Mc,b=this.j;g.Lw("yt-remote-session-browser-channel",{firstTestResults:[""],secondTestResults:!a.j.yC,sessionId:a.j.C,arrayId:a.j.ys});g.Lw("yt-remote-session-screen-id",b);a=y6();b=A6();g.ec(a,b)||a.push(b);$_a(a);B6()};
...
Object.assign(this.u,this.N),this.channel=new r7(this.pathPrefix,{eV:"gsessionid",JV:this.C,KV:this.u}),this.channel.open(),this.J=2,K1a(this))};
...
g.h.dispose=function(){this.j.dispose()};var S1a=Date.now(),b8=null,e8=Array(50),d8=-1,f8=!1;g.Ya(g8,g.Vv);g8.prototype.Nh=function(){return this.screens};
...
g.h.US=function(a){this.j=null;a.status&&404==a.status?this.u>=o3a.length?this.ea("pairingFailed",Error("DIAL polling timed out")):(a=o3a[this.u],this.Qb=g.ds((0,g.Ta)(this.VO,this),a),this.u++):this.ea("pairingFailed",Error("Server error "+a.status))};
g.h.WS=function(){this.j=null;this.ea("pairingFailed",Error("Server not responding"))};
var o3a=[2E3,2E3,1E3,1E3,1E3,2E3,2E3,5E3,5E3,1E4];g.Ya(j8,g8);g.h=j8.prototype;g.h.start=function(){i8(this)&&this.ea("screenChange");!g.Mw("yt-remote-lounge-token-expiration")&&W1a(this);g.fs(this.j);this.j=g.ds((0,g.Ta)(this.start,this),1E4)};
...
g.h.BH=function(){g.fs(this.B);this.B=NaN;this.u&&this.u.abort();var a=Y1a(this);if(n6(a)){var b=X7(this.D,"/pairing/get_screen_availability");this.u=Y7(this.D,b,{lounge_token:g.Pf(a).join(",")},(0,g.Ta)(this.lY,this,a),(0,g.Ta)(this.kY,this))}else o8(this,{}),p8(this)};
g.h.lY=function(a,b){this.u=null;var c=g.Pf(Y1a(this));if(g.vc(c,g.Pf(a))){b=b.screens||[];c={};for(var d=0,e=b.length;d<e;++d)c[a[b[d].loungeToken]]="online"==b[d].status;o8(this,c);p8(this)}else this.De("Changing Screen set during request."),this.BH()};
...
g.h.XS=function(a,b,c,d){g.js(X7(this.C,"/pairing/get_screen"),{method:"POST",postParams:{pairing_code:a},timeout:5E3,onSuccess:(0,g.Ta)(function(e,f){e=new r6(f.screen||{});if(!e.name||b2a(this,e.name)){a:{f=e.name;for(var k=2,l=b(f,k);b2a(this,l);){k++;if(20<k)break a;l=b(f,k)}f=l}e.name=f}c(r8(this,e))},this),
...
g.h.PU=function(){d2a(this);this.ea("screenChange");this.j.update()};
...
g.h.RH=function(){};
g.h.va=function(){this.info("disposeInternal");m2a(this);this.u&&(this.u.removeUpdateListener(this.ma),this.u.removeMessageListener("urn:x-cast:com.google.youtube.mdx",this.xa));this.u=null;t8.prototype.va.call(this)};
g.h.YY=function(a,b){if(!this.isDisposed())if(b)if(b=o6(b),g.Qa(b))switch(a=""+b.type,b=b.data||{},this.info("onYoutubeMessage_: "+a+" "+g.oj(b)),a){case "mdxSessionStatus":g2a(this,b);break;case "loungeToken":j2a(this,b);break;default:v8(this,"Unknown youtube message: "+a)}else v8(this,"Unable to parse message.");else v8(this,"No data in message.")};
g.h.pM=function(a,b,c,d){g.fs(this.N);this.N=0;a2a(this.B,this.j.label,a,this.j.friendlyName,(0,g.Ta)(function(e){e?b(e):0<=d?(v8(this,"Screen "+a+" appears to be offline. "+d+" retries left."),this.N=g.ds((0,g.Ta)(this.pM,this,a,b,c,d-1),300)):c(Error("Unable to fetch screen."))},this),c)};
...
g.h.stop=function(){t2a(this);this.u?this.u.stop((0,g.Ta)(this.Hg,this,null),(0,g.Ta)(this.Hg,this,"Failed to stop DIAL device.")):this.Hg()};
g.h.va=function(){t2a(this);this.u&&this.u.removeUpdateListener(this.ya);this.u=null;t8.prototype.va.call(this)};
...
g.h.va=function(){this.u.unsubscribe("onlineScreenChange",(0,g.Ta)(this.fJ,this));window.chrome&&chrome.cast&&chrome.cast.removeReceiverActionListener(this.D);var a=M1a,b=g.Ka("yt.mdx.remote.debug.handlers_");g.jc(b||[],a);g.uf(this.j);g.Vv.prototype.va.call(this)};
...
this.ea("yt-remote-cast2-session-change",this.j.getScreen()),Promise.resolve(new chrome.cast.DialLaunchResponse(!1));this.De('Changing CAST intent from "'+c.receiverType+'" to "dial" for '+b.friendlyName);H8(this,new z8(this.u,b,this.C,this.config_))}b=this.j;b.N=a;b.N.appState==chrome.cast.DialAppState.RUNNING?(a=b.N.extraData||{},c=a.screenId||null,A8(b)&&a.loungeToken?a.loungeTokenRefreshIntervalMs?a=q2a(b,{name:b.j.friendlyName,screenId:a.screenId,loungeToken:a.loungeToken,dialId:b.N.receiver.label,
screenIdType:"shortLived"},a.loungeTokenRefreshIntervalMs):(g.Or(Error("No loungeTokenRefreshIntervalMs presents in additionalData: "+JSON.stringify(a)+".")),a=r2a(b,c)):a=r2a(b,c)):a=C8(b);return a};
...
g.h.fJ=function(){this.isDisposed()||(this.B=w2a(this),F8("Updating custom receivers: "+g.oj(this.B)),chrome.cast.setCustomReceivers(this.B,function(){},(0,g.Ta)(function(){this.De("Failed to set custom receivers.")},this)),this.ea("yt-remote-cast2-availability-change",G8(this)))};
...
g.h.va=function(){I2a(this);this.C=null;this.D.clear();Z8(this,null);g.Vv.prototype.va.call(this)};
...
g.h.Bx=function(a){c8("CP","Cast media: "+!!a);this.j&&this.j.removeUpdateListener(this.N);if(this.j=a)this.j.addUpdateListener(this.N),J2a(this),this.ea("remotePlayerChange")};
g.h.EW=function(a){a?(J2a(this),this.ea("remotePlayerChange")):this.Bx(null)};
g.h.mI=function(){f9(this,"sendDebugCommand",{debugCommand:"stats4nerds "})};
g.h.IW=function(){var a=F2a();a&&Z8(this,a)};
...
n);this.D="UNSUPPORTED";c=this.Ea?"setInitialState":"setPlaylist";h9("Connecting with "+c+" and params: "+g.oj(m));this.u.connect({method:c,params:g.oj(m)},a,a0a())}else h9("Connecting without params"),this.u.connect({},a,a0a());N2a(this)};
...
g.h.FZ=function(a,b){n9(this,a,b);P2a(this)};
...
g.h.jX=function(){g.Zf(this.C)||k3a(this,this.C);this.D=!1};
...
g.h.wQ=function(){var a=this;if(J9(this)){var b=a9(this.dc);this.events.wc(this.Z);b.muted?this.I.mute():this.I.unMute();this.I.setVolume(b.volume);this.Z=this.events.T(this.I,"onVolumeChange",function(c){i3a(a,c)})}};
...
g.h.create=function(){var a=this.player.V(),b=g.fD(a);a={device:"Desktop",app:"youtube-desktop",loadCastApiSetupScript:a.S("mdx_load_cast_api_bootstrap_script"),enableDialLoungeToken:a.S("enable_dial_short_lived_lounge_token"),enableCastLoungeToken:a.S("enable_cast_short_lived_lounge_token")};d3a(b,a);this.subscriptions.push(g.qt("yt-remote-before-disconnect",this.yW,this));this.subscriptions.push(g.qt("yt-remote-connection-change",this.XX,this));this.subscriptions.push(g.qt("yt-remote-receiver-availability-change",this.DO,
...
g.h.load=function(){this.player.cancelPlayback();g.sM.prototype.load.call(this);this.Ai=new I9(this,this.player,this.dc);var a=(a=h3a())?a.currentTime:0;var b=F9()?new $8(z9(),void 0):null;0==a&&b&&(a=W8(a9(b)));0!==a&&this.Vb(a);m3a(this,this.Jd,this.Jd);this.player.Dl(6)};
...
g.h.DO=function(){var a=[this.vl],b=a.concat,c=e3a();O8()&&g.Mw("yt-remote-cast-available")&&c.push({key:"cast-selector-receiver",name:"Cast..."});this.ip=b.call(a,c);a=A9()||this.vl;R9(this,a);this.player.Qa("onMdxReceiversChange")};
